...
export default R.curry((ns: NS, scriptName: string, logLevel: LogLevel) => ({
    debug: (message: string): void => {
        const logString = `[${scriptName}] [DEBUG]: ${message}`
    ...
    info: (message: string): void => {
        const logString = `[${scriptName}] [INFO]: ${message}`
    ...
    warning: (message: string): void => {
        const logString = `[${scriptName}] [WARN]: ${message}`
    ...
    error: (message: string): void => {
        const logString = `[${scriptName}] [ERROR]: ${message}`
